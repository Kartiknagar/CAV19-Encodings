...
;PSI enforced for AV,RV and AE,RE, the rest of operations can run under EC
(assert (forall ((e1 E) (e2 E)) (=> (vis e1 e2) (not (vis e2 e1)) )))
(assert (forall ((e1 E) (e2 E)) (=> (and (not (= e1 e2)) (= (arg e1) (arg e2)) (= (op e1) AV) (= (op e2) RV) ) (or (vis e1 e2) (vis e2 e1) ) )))
(assert (forall ((e1 E) (e2 E)) (=> (and (not (= e1 e2)) (= (arg e1) (arg e2)) (= (op e1) AV) (= (op e2) RV) (vis e1 e2)) (eo e1 e2) ) ))
(assert (forall ((e1 E) (e2 E)) (=> (and (not (= e1 e2)) (= (arg e1) (arg e2)) (= (op e2) AV) (= (op e1) RV) (vis e1 e2)) (eo e1 e2) ) ))

(assert (forall ((e1 E) (e2 E)) (=> (and (not (= e1 e2)) (= (arge e1) (arge e2)) (= (op e1) AE) (= (op e2) RE) ) (or (vis e1 e2) (vis e2 e1) ) )))
(assert (forall ((e1 E) (e2 E)) (=> (and (not (= e1 e2)) (= (arge e1) (arge e2)) (= (op e1) AE) (= (op e2) RE) (vis e1 e2)) (eo e1 e2) ) ))
(assert (forall ((e1 E) (e2 E)) (=> (and (not (= e1 e2)) (= (arge e1) (arge e2)) (= (op e2) AE) (= (op e1) RE) (vis e1 e2)) (eo e1 e2) ) ))
