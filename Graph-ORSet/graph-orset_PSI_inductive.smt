...
(assert  (ite (vis1 e2 e1) (apply e2 ss1 ss1e  (src e1) (srce e1)) (and (= (src e1) ss1) (= (srce e1) ss1e) ) ))
(assert  (ite (vis1 e1 e2) (apply e1 ss2 ss2e  (src e2) (srce e2)) (and (= (src e2) ss2) (= (srce e2) ss2e) ) ))
...
;Note that CC is also required for the ORSet operations
;Also note that in this case, the encoding for PSI is same as PSI+RB because only operations which write to the same location are synchronized by PSI, and these are exactly the operations which PSI+RB synchronizes
