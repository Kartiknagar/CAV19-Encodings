...
(assert (forall ((t T)) (=> (and (=> (vis1 e1 e2) (not (vis1 e2 e1)))  (=> (vis1 e2 e1) (not (vis1 e1 e2))) (=> (and (= (eid e1) (ts (argE e2))) (= (op e1) Add) (= (op e2) Add)) (or (vis1 e1 e2) (vis1 e2 e1)))  (=> (and (= (eid e2) (ts (argE e1))) (= (op e1) Add) (= (op e2) Add)) (or (vis1 e1 e2) (vis1 e2 e1))) (=> (and (= (eid e1) (ts (argE e2))) (= (op e1) Add) (= (op e2) Add) (vis1 e1 e2)) (eo1 e1 e2)) (=> (and (= (eid e2) (ts (argE e1))) (= (op e1) Add) (= (op e2) Add) (vis1 e1 e2)) (eo1 e1 e2)) (=> (eo1 e1 e2) (not (eo1 e2 e1))) (=> (eo1 e2 e1) (not (eo1 e1 e2))) (=> (eo2 e2 e1) (not (eo2 e1 e2))) (=> (eo2 e1 e2) (not (eo2 e2 e1))) ) (and (= (c s12 t) (c s22 t) ) (= (c s12r t) (c s22r t) )) )))
