...
(assert (forall ((e1 E) (e2 E)) (=> (and (not (= e1 e2)) (= (argE e1) (argE e2)) (= (op e1) Add) (= (op e2) R) ) (or (vis e1 e2) (vis e2 e1) ) )))
(assert (forall ((e1 E) (e2 E)) (=> (and (not (= e1 e2)) (= (argE e1) (argE e2)) (= (op e1) Add) (= (op e2) R) (vis e1 e2)) (eo e1 e2) ) ))
(assert (forall ((e1 E) (e2 E)) (=> (and (not (= e1 e2)) (= (argE e1) (argE e2)) (= (op e2) Add) (= (op e1) R) (vis e1 e2)) (eo e1 e2) ) ))

(assert (forall ((e1 E) (e2 E)) (=> (and (not (= e1 e2)) (= (eid e1) (ts (argE e2))) (= (op e1) Add) (= (op e2) Add) ) (or (vis e1 e2) (vis e2 e1) ) )))
(assert (forall ((e1 E) (e2 E)) (=> (and (not (= e1 e2)) (= (eid e1) (ts (argE e2))) (= (op e1) Add) (= (op e2) Add) (vis e1 e2)) (eo e1 e2) ) ))
(assert (forall ((e1 E) (e2 E)) (=> (and (not (= e1 e2)) (= (eid e1) (ts (argE e2))) (= (op e1) Add) (= (op e2) Add) (vis e2 e1)) (eo e2 e1) ) ))
(assert (forall ((e1 E) (e2 E)) (=> (and (not (= e1 e2)) (= (eid e1) (ts (argE e2))) (= (op e1) Add) (= (op e2) R) ) (or (vis e1 e2) (vis e2 e1) ) )))
(assert (forall ((e1 E) (e2 E)) (=> (and (not (= e1 e2)) (= (eid e1) (ts (argE e2))) (= (op e1) Add) (= (op e2) R) (vis e1 e2)) (eo e1 e2) ) ))
(assert (forall ((e1 E) (e2 E)) (=> (and (not (= e1 e2)) (= (eid e2) (ts (argE e1))) (= (op e2) Add) (= (op e1) R) (vis e1 e2)) (eo e1 e2) ) ))
